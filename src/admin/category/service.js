    ...
    try {
        if (req.query.EditId != undefined && req.query.EditId != "") {
            ...
            if (req.query.id != "" && req.query.id != undefined) {
                req.body.parent_Name = new mongoose.Types.ObjectId(req.query.id)
            }
            const result = await CategoryModal.findByIdAndUpdate({ _id: new mongoose.Types.ObjectId(req.query.EditId) }, req.body, { new: true })
